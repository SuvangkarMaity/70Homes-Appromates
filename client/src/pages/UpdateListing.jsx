...
export default function CreateListing() {
    ...
    if (files.length > 0 && files.length + formData.imageUrls.length < 7) {
      ...
      Promise.all(promises)
        .then((urls) => {
          ...
          }); // keep previous images and add new urls
          setImageUploadError(false);
          setUploading(false);
        })
        .catch((err) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      // Modify user_type before submission
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
          ...
          <span className="text-red-500 text-lg -mb-5">*</span>
            ...
            <div className="p-4 border rounded-lg shadow-sm mt-4">
              <h3 className="text-lg font-semibold mb-4"><span className="text-red-500 text-lg -mb-5">*</span>Property Images</h3>
